...
Ansible role to setup slurm jobs with gpu stats reporting to prometheus. Uses https://github.com/guilbaults/slurm-job-exporter to collect and provide metrics.
